...
export default function addAttachFunction(container) {
  ...
  /**
   * Attach an object to this model at the specified bone name.
   * If the bone name is not found, it will default to the root of the model.
   * @param {import(".").DLModel} object
  ...
  /**
   * Attach this model to another model at the specified bone name.
   * @param {import(".").DLModel} target
   * @param {string} boneName
   */
